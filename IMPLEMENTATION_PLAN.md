...
- [ ] (H2) `admin.py` POST `/admin/sources/discover-paths` 라우트 — JSON body (domain 필수 + keyword 선택, 없으면 active 키워드 첫 번째 또는 "AI"). discover_paths 호출 결과 JSON 반환. 테스트: 정상 + 잘못된 domain reject + Brave 실패 시 503.
